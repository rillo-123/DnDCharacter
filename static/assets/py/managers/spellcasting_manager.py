...
try:
    ...
    # Fallback constants - moved here from spell_data.py since it can't be imported in Pyodide
    LOCAL_SPELLS_FALLBACK = []
    SPELL_CLASS_SYNONYMS = {}
    SPELL_CLASS_DISPLAY_NAMES = {}
    ...
    # Spell casting progression tables - moved from spell_data.py
    CLASS_CASTING_PROGRESSIONS = {
        "artificer": "artificer",
        "bard": "full",
        "cleric": "full",
    ...
    # Spell slot progressions by class type - moved from spell_data.py
    SPELLCASTING_PROGRESSION_TABLES = {
        "full": {
            1: {1: 2},
            2: {1: 3},
